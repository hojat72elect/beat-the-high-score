...
import com.github.dwursteisen.beat.addons.ashley.fsm.EntityState
import com.github.dwursteisen.beat.addons.core.emptyGdxArray


/**
 * An entity can hold states using [StateComponent].
 * A state can be assigned for one component.
 *
 */
